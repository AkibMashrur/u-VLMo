...
def generate(model, image, device, config):
    ...
    caption = model_without_ddp.generate(image, sample=False, num_beams=config['num_beams'], max_length=config['max_length'],
...
def prepare_image(args, config):
    print(f"Reading image at {args.image_path}")
...
def main(args, config):
    ...
    image = prepare_image(args, config)
